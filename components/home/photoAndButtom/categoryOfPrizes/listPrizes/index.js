                    ...
                    <Grid>
                        <Row size={50}>
                            <Left style={{ flexDirection: 'row' }}>
                                ...
                                <Title style={{ alignSelf: "center", left: 15, color: "#FFF", fontSize: wp(10) }}>{_.truncate(_.startCase(categoryPrizes.name), { length: 17, separator: "..." })}</Title>
                            </Left>
                        </Row>
                                    ...
                                    <Animatable.View
                                        ...
                                        <ImageBackground
                                            ...
                                            <View style={{
                                                ...
                                                <Text style={{ color: "#FFF", fontSize: 28, top: 0, padding: 10 }}>
                                                    {item.general.nameOfPrize}
                                                </Text>
                                                <Text style={{ color: "#FFF", fontSize: wp(3.5), position: "absolute", bottom: 0, padding: 10, right: 0, fontStyle: 'italic' }}>
